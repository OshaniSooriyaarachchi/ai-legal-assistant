...
const SignUp: React.FC = () => {
  ...
  const [localError, setLocalError] = useState<string | null>(null); // Added missing state variable
  ...
  const handleGoogleSignUp = async () => {
    try {
      ...
      setLocalError(error.message || 'An unexpected error occurred'); // Use the local error state setter
    }
  };
  ...
  // Display either Redux error, validation error, or local error
